...
import { ModalProviderState, selectModalProviderState, useAppSelector } from 'App'
...
export const ComplexModal = () => {
	...
	const { props } = useAppSelector(selectModalProviderState) as ModalProviderState<ComplexModalProps>
