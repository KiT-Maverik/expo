  ...
  styleOverrides: (() => {
    ...
    return {
      root: ({
        ...
        borderBottom:
          mode === "banner"
            ? `1px solid ${palette?.[severity as AlertColor].main}`
            : "",

        backgroundColor: (() => {
          if (variant === "filled")
            return palette?.[severity as AlertColor].main;
          if (variant === "standard")
        ...
        svg: {
          color:
            variant === "filled"
              ...
              : palette?.[severity as AlertColor].main,
        },
      }),
      message: ({ theme, ownerState: { severity, variant, isBanner } }) => {
        const color =
          variant === "filled"
            ...
            : colorSchema.text[severity as AlertColor];
